    ...
    public void listOptionsSucceeds() throws Exception {
        ...
        try {
            ...
            for (SaneOption option : options) {
                ...
                if (option.getType() != OptionValueType.tmp_button()) {
        ...
        try {
            ...
            for (SaneOption option : options) {
                ...
                if (!option.isActive()) {
                    ...
                    if (option.getType() == OptionValueType.tmp_int() && option.getValueCount() == 1
                            && option.isActive()) {
                        System.out.print("=" + option.getIntegerValue());
                    } else if (option.getType() == OptionValueType.tmp_string()) {
...
//      assertProducesCorrectImage(device, "Color", 16, "Color pattern");
    ...
    public void readsStringListConstraintsCorrectly() throws Exception {
        ...
        try {
            ...
            assertThat(option.getConstraintType()).isEqualTo(OptionValueConstraintType.tmp_stringList());
